...
export function Kamar1({ isOpen, onClose }: ModalProps) {  
  return (
    <div
      className={`fixed z-30 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[100vh] w-[100vw] backdrop-brightness-50 ${isOpen ? "flex" : "hidden"}`}
    >
        ...
        <div className="animate-slide-up w-[80%] md:w-1/2 h-max bg-main rounded-xl flex flex-col p-4">
          ...
          <div className="py-8 flex flex-col justify-between gap-4 h-full">
            <p className="text-sm md:text-lg text-white">
              Dilengkapi dengan kasur, bantal, guling, dan lemari di tiap
              kamarnya. Lantai 1 memiliki dapur umum serta dua kamar mandi
              bersama. Sementara Gas pada dapur umum dibayar dengan sistem
              urunan bersama penghuni lantai 1 lainnya
            </p>
...
export function Kamar2({ isOpen, onClose }: ModalProps){  
  return (
    <div
      className={`fixed z-30 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[100vh] w-[100vw] backdrop-brightness-50 ${isOpen ? "flex" : "hidden"}`}
    >
      <div className="w-screen h-screen flex justify-center items-center">
        <div className="animate-slide-up w-[80%] md:w-1/2 h-max bg-main rounded-xl flex flex-col p-4">
          <div className="flex justify-between">
            <h1 className="text-xl text-white font-bold">Kamar Lt. 2</h1>
            <button onClick={onClose}>
              <svg
                width="25"
                height="25"
          ...
          <div className="py-8 flex flex-col justify-between gap-4 h-full">
            <p className="text-sm md:text-lg text-white">
            Dilengkapi dengan kasur, bantal, guling, dan lemari di tiap kamarnya. Lantai 1 memiliki dapur umum serta dua kamar mandi bersama, Balkon untuk jemuran serta sinar matahari langsung. Sementara Gas pada dapur umum dibayar dengan sistem urunan bersama penghuni lantai 2 lainnya
            </p>
            <div className="flex justify-center gap-2">
              <div className="w-1/3 aspect-square rounded-lg bg-blue-500"></div>
              <div className="w-1/3 aspect-square rounded-lg bg-blue-500"></div>
...
export function Kamar3({ isOpen, onClose }: ModalProps){  
  return (
    <div
      className={`fixed z-30 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[100vh] w-[100vw] backdrop-brightness-50 ${isOpen ? "flex" : "hidden"}`}
    >
      <div className="w-screen h-screen flex justify-center items-center">
        <div className="animate-slide-up w-[80%] md:w-1/2 h-max bg-main rounded-xl flex flex-col p-4">
          <div className="flex justify-between">
            <h1 className="text-xl text-white font-bold">Kamar Lt. 3</h1>
            <button onClick={onClose}>
              <svg
                width="25"
                height="25"
