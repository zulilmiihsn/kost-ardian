...
import Kamar from "../modal/kamarSatu";
    ...
    <main>
      ...
      <section className="md:h-screen flex flex-col gap-16">
        ...
        >
          <div className="w-screen h-screen flex justify-center items-center">
            <div className="animate-slide-up w-1/2 h-1/2 bg-main bg-opacity-10 rounded-xl flex flex-col p-4">
      ...
      <section className="h-screen flex flex-col justify-around px-12 py-8">
        ...
        <div className="w-fit flex flex-row gap-1">
          <button onMouseEnter={hoverSounds} onClick={clickSounds} className="aspect-square w-12 rounded-full bg-white grid place-content-center hover:drop-shadow-glow transition ease-in-out hover:-translate-y-1 active:translate-y-1">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
          ...
          <button onMouseEnter={hoverSounds} onClick={clickSounds} className="aspect-square w-12 rounded-full bg-white grid place-content-center hover:drop-shadow-glow transition ease-in-out active:translate-y-1 hover:-translate-y-1">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
