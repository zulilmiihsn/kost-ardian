...
export default function Kamar() {
    ...
    return (
        ...
        <div className="w-screen h-screen flex justify-center items-center">
            <div className=" translate-y-2 transition ease-in-out w-1/2 h-1/2 bg-main bg-opacity-10 rounded-xl flex flex-col p-4">
        ...
        <button
            ...
            >
              ...
              <div className="h-4/5 p-8">
                <h1 className="font-bold text-lg">Kamar 1</h1>
